      ...
      : super(
          ...
          scenarios: [
            UnitScenario<BaseViewModelImplementation, UnitExample>(
              description:
                  'Responsive sizing based on using the BaseViewModel.scaledHeight method',
              examples: [
                _ScaledHeightExample(
                    value: 64,
                    originalDesignHeight: 600,
                    stubbedCurrentHeight: 400),
                _ScaledHeightExample(
                    value: 150,
                    originalDesignHeight: 600,
                    stubbedCurrentHeight: 400),
              ...
              steps: [
                WhenThen(
                  ...
                  (systemUnderTest, log, box, mocks, [example]) {
                    ...
                    final actualScaledHeightValue =
                        systemUnderTest.scaledHeight(
                            value: value,
                            originalDesignHeight: originalDesignHeight);
                    log.info(
